...
let testCase() =
    ...
    {workers=workers;schedule=simplexschedule;maxHoursPerWeek=50.0<Hour>;options={expenseMinimizing=true;strainMinimizing=true;capMaximumWorkingHoursConstraint=false;ensureQualifiedPersonellConstraint=true;noDoubleShiftConstraint=false}}